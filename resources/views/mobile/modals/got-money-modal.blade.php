<!-- You Got Modal -->
<div class="modal fade" id="youGotModal" tabindex="-1" aria-labelledby="youGotModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="youGotModalLabel">You got ₹ 0 to {{ isset($customer) && isset($customer->name) ? $customer->name : '' }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{route('gave.money')}}" method="POST" method="POST" enctype="multipart/form-data">
                @csrf
